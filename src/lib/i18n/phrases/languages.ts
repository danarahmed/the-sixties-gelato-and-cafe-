...
const phrases: PhraseBook = {
  ...
  "Every screen is in English, Arabic and Kurdish. Add another language, or give any phrase the café's own words.":
    {
      ar: "كل شاشة متاحة بالإنجليزية والعربية والكردية. أضف لغة أخرى، أو أعطِ أي عبارة كلمات المقهى الخاصة.",
      ckb: "هەموو شاشەیەک بە ئینگلیزی و عەرەبی و کوردییە. زمانێکی تر زیاد بکە، یان بە هەر دەستەواژەیەک وشەی تایبەتی کافێکە بدە.",
    },
  "Open Languages →": { ar: "افتح اللغات ←", ckb: "زمانەکان بکەرەوە ←" },
