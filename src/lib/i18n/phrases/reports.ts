...
const phrases: PhraseBook = {
  ...
  "Sales recorded vs net revenue in the ledger (4000 less 4100 and 4200)": {
    ...
    ckb: "فرۆشتنی تۆمارکراو بەرامبەر داهاتی ڕەسەن لە دەفتەری گشتیدا (4000 بە کەمکردنەوەی 4100 و 4200)",
  },
  ...
  Income: { ar: "الإيرادات", ckb: "داهات" },
  "Net revenue": { ar: "صافي الإيرادات", ckb: "داهاتی ڕەسەن" },
  "Cost of sales": { ar: "تكلفة المبيعات", ckb: "تێچووی فرۆشتن" },
  "Operating expenses": { ar: "المصروفات التشغيلية", ckb: "خەرجییەکانی کارکردن" },
  "Net loss": { ar: "صافي الخسارة", ckb: "زیانی ڕەسەن" },
  "Net profit": { ar: "صافي الربح", ckb: "قازانجی ڕەسەن" },
  ...
  "Sales {from} to {to}, voids excluded; refunds on the day they were made": {
    ar: "المبيعات من {from} إلى {to}، دون المبيعات الملغاة؛ والاسترجاعات في يوم إجرائها",
  ...
  Refunds: { ar: "الاسترجاعات", ckb: "گەڕاندنەوەی پارە" },
  ...
  "Net sales are what the P&L shows as net revenue for the same dates (4000 less 4100 and 4200). The sales margin is net sales less the recipe cost of what was sold; the P&L's gross profit also takes off waste, count differences, purchase price differences and platform fees.":
    {
      ...
      ckb: "فرۆشی ڕەسەن ئەوەیە کە ڕاپۆرتی قازانج و زیان وەک داهاتی ڕەسەن بۆ هەمان بەروارەکان پیشانی دەدات (4000 بە کەمکردنەوەی 4100 و 4200). پەراوێزی قازانجی فرۆشتن فرۆشی ڕەسەنە بە کەمکردنەوەی تێچووی ڕەسەتەی ئەوەی فرۆشراوە؛ قازانجی گشتی لە ڕاپۆرتی قازانج و زیاندا بەفیڕۆچوون، جیاوازییەکانی ژماردن، جیاوازییەکانی نرخی کڕین و کرێی پلاتفۆرمەکانیش کەم دەکاتەوە.",
    },
  ...
  "Voids, refunds, discounts, cancelled bills, items taken off bills and wrong PINs, {from} to {to} · <csv>CSV</csv>":
    {
      ar: "إلغاءات البيع والاسترجاعات والخصومات والفواتير الملغاة والأصناف المُزالة من الفواتير ورموز PIN الخاطئة، من {from} إلى {to} · <csv>CSV</csv>",
  ...
  "Nothing was voided, refunded, discounted, cancelled or taken off a bill in these dates.": {
    ar: "لا إلغاء بيع ولا استرجاع ولا خصم ولا فاتورة ملغاة ولا صنف أُزيل من فاتورة في هذه التواريخ.",
  ...
  "{n} wait for your review: a void or refund nobody else approved, a wrong PIN, or a discount over the cap given before discounts were checked. Discounts over the cap need a manager's approval on the till; a void or refund may be approved there by a second person with their name and PIN.":
    {
      ar: "بانتظار مراجعتك: {n} — إلغاء بيع أو استرجاع لم يوافق عليه شخص آخر، أو رمز PIN خاطئ، أو خصم فوق الحد أُعطي قبل أن تُفحص الخصومات. الخصم فوق الحد يحتاج إلى موافقة مدير على نقطة البيع؛ ويمكن أن يوافق على إلغاء البيع أو الاسترجاع هناك شخص ثانٍ باسمه ورمز PIN الخاص به.",
  ...
  "a void or refund nobody else approved, a wrong PIN, or a discount over the cap given before discounts were checked. Discounts over the cap need a manager's approval on the till; a void or refund may be approved there by a second person with their name and PIN.":
    {
      ar: "ما ينتظر المراجعة: إلغاء بيع أو استرجاع لم يوافق عليه شخص آخر، أو رمز PIN خاطئ، أو خصم فوق الحد أُعطي قبل أن تُفحص الخصومات. الخصم فوق الحد يحتاج إلى موافقة مدير على نقطة البيع؛ ويمكن أن يوافق على إلغاء البيع أو الاسترجاع هناك شخص ثانٍ باسمه ورمز PIN الخاص به.",
  ...
  Refund: { ar: "استرجاع", ckb: "گەڕاندنەوەی پارە" },
  ...
  "A sale is never edited. A sale rung in error is <b>voided</b> until the drawer holding it is counted — revenue, payment, cost and stock all come back exactly. After that, money goes back to the customer by a <b>refund</b>, through Sales returns (4200); only goods that can go back on the shelf return to stock. Both take a reason from the list and are on the audit trail; one approved by a second person (their name and PIN) is marked so, and one without waits for the owner on the exceptions report.":
    {
      ar: "لا يُعدَّل البيع أبدًا. البيع المسجَّل خطأً <b>يُلغى</b> ما دام درج النقد الذي يحويه لم يُعدّ بعد — فتعود الإيرادات والدفعة والكلفة والمخزون كما كانت تمامًا. بعد ذلك يعود المال إلى الزبون عبر <b>الاسترجاع</b>، من خلال مردودات المبيعات (4200)؛ ولا يعود إلى المخزون إلا ما يمكن إرجاعه إلى الرف. كلاهما يأخذ سببًا من القائمة ويُسجَّل في سجل التدقيق؛ وما وافق عليه شخص ثانٍ (باسمه ورمز PIN الخاص به) يُعلَّم بذلك، وما لم يوافق عليه أحد ينتظر المالك في تقرير الاستثناءات.",
  ...
  "Their net sales": { ar: "صافي مبيعاتها", ckb: "فرۆشی ڕەسەنیان" },
  ...
  Paid: { ar: "طريقة الدفع", ckb: "شێوەی پارەدان" },
  ...
  "Confirm refund": { ar: "تأكيد الاسترجاع", ckb: "دڵنیاکردنەوەی گەڕاندنەوەی پارە" },
  ...
  "What happened": { ar: "ما الذي حدث", ckb: "چی ڕوویدا" },
  ...
  "Written by the database in the same step as the change, and never edited or deleted. Prices, products, stock items and their units, opening stock, suppliers, recipes, business settings and places are recorded however they are changed — on a screen, or in the database, where no one is signed in. Sales, refunds, discounts, counts, cash and the books are recorded by the steps that make them. See also the <journals>journal register</journals> for every posting.":
    {
      ar: "تكتبه قاعدة البيانات في الخطوة نفسها التي يحدث فيها التغيير، ولا يُعدَّل ولا يُحذف أبدًا. تُسجَّل الأسعار والمنتجات ومواد المخزون ووحداتها والرصيد الافتتاحي والمورّدون والوصفات وإعدادات العمل والأماكن كيفما تغيّرت — على شاشة، أو في قاعدة البيانات حيث لا يكون أحد مسجّلًا الدخول. أما المبيعات والاسترجاعات والخصومات والجرد والنقد والدفاتر فتسجّلها الخطوات التي تُجريها. وانظر أيضًا <journals>سجل القيود</journals> لكل ترحيل.",
  ...
  "Opening stock recorded": { ar: "تسجيل الرصيد الافتتاحي", ckb: "تۆمارکردنی باڵانسی سەرەتا" },
  ...
  "Delivery price confirmed": { ar: "تأكيد سعر التوريد", ckb: "دڵنیاکردنەوەی نرخی بار" },
  "Sale voided": { ar: "إلغاء بيع", ckb: "هەڵوەشاندنەوەی فرۆشتن" },
  "Sale refunded": { ar: "استرجاع بيع", ckb: "گەڕاندنەوەی پارەی فرۆشتن" },
  ...
  "Cash moved": { ar: "نقل نقد", ckb: "گواستنەوەی پارەی کاش" },
  ...
  "Reorder level": { ar: "حد إعادة الطلب", ckb: "ئاستی داواکردنەوە" },
  "Par level": { ar: "المستوى المعتاد", ckb: "ئاستی ئاسایی" },
  ...
  "Back on the shelf when refunded": {
    ar: "يعود إلى الرف عند الاسترجاع",
    ckb: "لە کاتی گەڕاندنەوەی پارە دەگەڕێتەوە سەر ڕەفە",
  },
  "What they supply": { ar: "ما يورّدونه", ckb: "ئەوەی دابینی دەکەن" },
  ...
  "One batch makes": { ar: "الدفعة الواحدة تُنتج", ckb: "یەک دەفعە بەرهەم دەهێنێت" },
  Value: { ar: "القيمة", ckb: "بەها" },
  Receipt: { ar: "الإيصال", ckb: "وەسڵ" },
  ...
  "Days a delivery takes": { ar: "أيام وصول التوريد", ckb: "ڕۆژەکانی گەیشتنی بار" },
  ...
  "The terminal's total": { ar: "مجموع جهاز البطاقات", ckb: "کۆی ئامێری کارت" },
  "Reached the bank": { ar: "وصل إلى البنك", ckb: "گەیشتە بانک" },
  ...
  Fees: { ar: "الرسوم", ckb: "کرێکان" },
  "On lines not posted": { ar: "على سطور غير مرحّلة", ckb: "لەسەر هێڵە تۆمارنەکراوەکان" },
  ...
  Expected: { ar: "المتوقع", ckb: "چاوەڕوانکراو" },
  Email: { ar: "البريد الإلكتروني", ckb: "ئیمەیڵ" },
  Delta: { ar: "التغيّر", ckb: "گۆڕان" },
  Counted: { ar: "المعدود", ckb: "ژمێردراو" },
  ...
  "since {when}": { ar: "منذ {when}", ckb: "لە {when} ەوە" },
