...
select test.eq((
  ...
  'acknowledge_alert,add_item_unit,adjust_stock,alert_thresholds,approve_stock_count,cancel_bill,cancel_production,cancel_scheduled_price,cancel_scheduled_recipe,'
