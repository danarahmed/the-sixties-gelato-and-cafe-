...
select test.eq((
  ...
  'adjust_stock,approve_stock_count,cancel_bill,cancel_production,cancel_tab,change_product_recipe,clear_product_image,'
  'close_day,create_item,create_product,'
  ...
  'record_count,record_expense,record_production,'
