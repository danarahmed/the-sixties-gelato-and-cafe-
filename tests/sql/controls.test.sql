...
select test.eq((
  ...
  'discard_journal,invite_member,legacy_unposted,list_members,lock_period,menu_costing,menu_recipe_lines,my_profile,'
  'new_recipe_version,pay_bill,period_close_checklist,'
  'pos_catalogue,post_control_correction,post_legacy_unposted,publish_journal,receive_goods,record_bill,record_count,record_expense,'
  'record_sale,record_waste,'
  'refund_sale,reject_stock_count,report_daily_sales,report_day_totals,report_profit_and_loss,'
  'report_reconciliation,report_trial_balance,report_unclosed_days,reverse_journal,review_stock_count,save_journal,'
  'set_member_active,set_member_roles,set_price,start_stock_count,submit_stock_count,unlock_period,void_sale',
